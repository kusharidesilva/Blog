...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  const post = getPostBySlug("lifestyle", slug);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="relative h-48 md:h-64 rounded-xl overflow-hidden mb-8 bg-gradient-to-r from-pink-500 to-rose-600 flex items-center justify-center">
